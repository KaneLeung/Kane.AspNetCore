...
* 作　　者 ：Kane Leung
* 创建时间 ：2020/07/04 16:38:55
* 更新时间 ：2020/07/04 16:38:55
* 版 本 号 ：v1.0.0.0
*******************************************************************
...
namespace Kane.AspNetCore
{
    ...
    public static class DIEx
    {
        ...
        #region 基于【IApplicationBuilder】获取服务，如获取失败返回Null + GetService<T>(this IApplicationBuilder builder)
        /// <summary>
        /// 基于<see cref="IApplicationBuilder"/>获取服务，如获取失败返回Null
        /// </summary>
        /// <typeparam name="T">要获取的服务类型</typeparam>
        /// <param name="builder">当前请求管道构建器</param>
        /// <returns></returns>
        public static T GetService<T>(this IApplicationBuilder builder) => builder.ApplicationServices.GetService<T>();
        #endregion

        #region 基于【IApplicationBuilder】获取服务，如获取失败抛异常 + GetRequiredService<T>(this IApplicationBuilder builder)
        /// <summary>
        /// 基于<see cref="IApplicationBuilder"/>获取服务，如获取失败抛异常
        /// </summary>
        /// <typeparam name="T">要获取的服务类型</typeparam>
        /// <param name="builder">当前请求管道构建器</param>
        /// <returns></returns>
        public static T GetRequiredService<T>(this IApplicationBuilder builder) => builder.ApplicationServices.GetRequiredService<T>();
        #endregion
